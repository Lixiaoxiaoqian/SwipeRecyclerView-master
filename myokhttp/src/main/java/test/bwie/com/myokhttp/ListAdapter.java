...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder>
    ...
    public ListAdapter(List<GsonBean.DataBean> list, Context context) {
        this.list = list;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View root) {
            ...
            checkBox = (CheckBox) root.findViewById(R.id.id_check_box);
        }
    }
...
//            holder.checkBox.startAnimation(animation);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View root = LayoutInflater.from(parent.getContext()).inflate(R.layout.rlv_itemone, null, false);
