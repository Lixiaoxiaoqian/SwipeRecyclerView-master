...
import com.byl.recyclerview.other.RecyclerViewClickListener;
...
public class PullRecyclerView extends PullBaseView<RecyclerView> {
    ...
    public void addOnItemTouchListener(RecyclerViewClickListener recyclerViewClickListener) {
        mRecyclerView.addOnItemTouchListener(recyclerViewClickListener);
    }
